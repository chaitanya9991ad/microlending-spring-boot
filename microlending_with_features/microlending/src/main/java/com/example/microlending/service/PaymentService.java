...
public class PaymentService {
    ...
    private void sendPaymentReceiptEmail(Payment payment) {
        ...
        // --- THIS IS THE FIX ---
        // The 'success' variable doesn't exist here.
        // Instead, we check the status of the 'payment' object that was passed in.
        if ("SUCCESS".equals(payment.getStatus())) {
            // Check if the list already contains this paymentId to avoid double-counting
            // (This can happen in a transactional context)
