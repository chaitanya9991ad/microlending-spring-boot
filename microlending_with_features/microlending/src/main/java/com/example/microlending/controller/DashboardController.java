...
public class DashboardController {
    ...
    // 2️⃣ Get all payments of a user (using the efficient query)
    ...
    // 3️⃣ Get dashboard summary for a user
    ...
    public ResponseEntity<Map<String, Object>> getUserDashboardSummary(@PathVariable Long userId) {
        ...
        // Calculate total loan amount (only for approved/closed loans)
        ...
        // Calculate total paid (only for successful payments)
